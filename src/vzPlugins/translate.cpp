...
{
	{"f_x", "X offset",PLUGIN_PARAMETER_OFFSET(default_value,f_x)},
	{"f_y", "Y offset",PLUGIN_PARAMETER_OFFSET(default_value,f_y)},
	{"f_z", "Z offset",PLUGIN_PARAMETER_OFFSET(default_value,f_z)},
	{NULL,NULL,0}
};
